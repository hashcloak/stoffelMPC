...
use crate::state::{Register, Memory};
...
pub enum Opcode {
    ...
    RUN_TAPE(InstructionOpcode, RegisterAddr, RegisterAddr, RegisterAddr, RegisterAddr),
    ...
    ADDCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    ADDSI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    ...
    SUBCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    SUBSI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    SUBCFI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    SUBSFI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    /// Multiplication/division
    ...
    MULCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    MULSI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    DIVC(InstructionOpcode, RegisterAddr, RegisterAddr, RegisterAddr),
    DIVCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    MODC(InstructionOpcode, RegisterAddr, RegisterAddr, RegisterAddr),
    MODCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    LEGENDREC(InstructionOpcode, RegisterAddr, RegisterAddr),
    DIGESTC(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    INV2M(InstructionOpcode, RegisterAddr, ImmediateValue),
    FLOORDIVC(InstructionOpcode, RegisterAddr, RegisterAddr),
    /// Open
    // TODO: Figure out sensible way of handling variable length arguments
    MULS(InstructionOpcode, ImmediateValue, RegisterAddr, RegisterAddr, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    MULRS(InstructionOpcode, ImmediateValue, ImmediateValue, RegisterAddr, RegisterAddr, RegisterAddr),
    // TODO: Minimize parameters
    // TODO: Figure out sensible way of handling variable length arguments
    DOTPRODS(InstructionOpcode, ImmediateValue, ImmediateValue, RegisterAddr, RegisterAddr, RegisterAddr, RegisterAddr),
    TRUNC_PR(InstructionOpcode, ImmediateValue, RegisterAddr, RegisterAddr, ImmediateValue, ImmediateValue),
    MATMULS(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, ImmediateValue),
    MATMULSM(InstructionOpcode, RegisterAddr, RegisterAddr, RegisterAddr, ImmediateValue, ImmediateValue, ImmediateValue, RegisterAddr, RegisterAddr, RegisterAddr, RegisterAddr, ImmediateValue, ImmediateValue),
    ...
    // TODO: Figure out sensible way of handling variable length arguments
    EDABIT(InstructionOpcode, ImmediateValue, RegisterAddr, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    SEDABIT(InstructionOpcode, ImmediateValue, RegisterAddr, RegisterAddr),
    ...
    /// INPUTFIX = 0xF0,
    /// INPUTFLOAT = 0xF1,
    INPUTMIXED(InstructionOpcode, ImmediateValue, RegisterAddr, Option<RegisterAddr>, Option<RegisterAddr>, Option<RegisterAddr>, Option<ImmediateValue>, ImmediateValue),
    /// INPUTMIXEDREG = 0xF3,
    RAWINPUT(InstructionOpcode, ImmediateValue, ImmediateValue, RegisterAddr),
    /// May not be needed INPUTPERSONAL = 0xF5,
    // TODO: Figure out sensible way of handling variable length arguments
    READSOCKETC(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    READSOCKETS(InstructionOpcode, ImmediateValue, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    WRITESOCKETC(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    WRITESOCKETS(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    READSOCKETINT(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    WRITESOCKETINT(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    WRITESOCKETSHARE(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, RegisterAddr),
    ...
    ANDCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    XORCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    ORCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    NOTC(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    /// Bitwise shifts
    ...
    SHLCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    SHRCI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    SHRSI(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    /// Branching and comparison
    ...
    LTC(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue),
    GTC(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue),
    EQC(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue),
    JMPI(InstructionOpcode, ImmediateValue),
    /// Integers
    // TODO: Figure out sensible way of handling variable length arguments
    BITDECINT(InstructionOpcode, ImmediateValue, RegisterAddr, RegisterAddr, RegisterAddr),
    ...
    INCINT(InstructionOpcode, ImmediateValue, ImmediateValue, ImmediateValue, ImmediateValue, ImmediateValue),
    SHUFFLE(InstructionOpcode, RegisterAddr, RegisterAddr),
    /// Conversion
    CONVINT(InstructionOpcode, RegisterAddr, RegisterAddr),
    CONVMODP(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    ...
    STARTPRIVATEOUTPUT(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    STOPPRIVATEOUTPUT(InstructionOpcode, RegisterAddr, RegisterAddr, ImmediateValue),
    /// PRINTFLOATPLAIN = 0xBC,
    // TODO: Figure out sensible way of handling variable length arguments
    WRITEFILESHARE(InstructionOpcode, ImmediateValue, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    READFILESHARE(InstructionOpcode, ImmediateValue, ImmediateValue, RegisterAddr, RegisterAddr),
    /// CONDPRINTSTR = 0xBF,
    /// PRINTFLOATPREC = 0xE0,
    /// CONDPRINTPLAIN = 0xE1,
    INTOUTPUT(InstructionOpcode, ImmediateValue, RegisterAddr),
    FLOATOUTPUT(InstructionOpcode, ImmediateValue, RegisterAddr, RegisterAddr, RegisterAddr, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    GBITDEC(InstructionOpcode, RegisterAddr, ImmediateValue, RegisterAddr),
    // TODO: Figure out sensible way of handling variable length arguments
    GBITCOM(InstructionOpcode, RegisterAddr, ImmediateValue, RegisterAddr),
}
